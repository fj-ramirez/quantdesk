...
## 22. T52: ETF shares-outstanding ingest -- XLSX parsing, precision, and `compute_flows`
...
### 22.1 XLSX parsing: stdlib `zipfile`, not `openpyxl`
...
acceptance check (§22.4 below) with no code path difference from the fixture-driven test.

### 22.2 Shares-outstanding precision: `TNA / NAV`, printed value as a cross-check
...
### 22.3 `compute_flows`: hand computation
...
### 22.4 Live acceptance check (2026-09-09, real network, real Postgres)

 ...
 * touched, and nothing here reads any endpoint beyond `GET /api/gex/scan/flows?window=` and the
 * `flows` block of `GET /api/gex/health/capture`, both already live.
 *
 ...
 * `/api/gex/health/capture`'s `flows` block (07-ui.md's instruction: "from the flows health
 * block"), falling back to the current `/api/gex/scan/flows` response's own `sources` field

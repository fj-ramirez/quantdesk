...
describe('a symbol with no snapshot captured yet', () => {
  /** Exactly what `RegimeRowOut.missing` (backend `app/modules/gex/api/scan.py`) serializes: every
   ...
   *
   * Captured verbatim from `GET /api/gex/scan/regime` against a freshly-migrated, empty database

/**
 * T55 — reads `GET /api/gex/health/capture` and renders the `bars` block's freshness summary
 * ("Bars through Mon 8 Sep · 47 symbols") for the scan-family TopBar toolbar (07-ui.md:
 * "bars freshness ... from the `bars` block of `/api/gex/health/capture`"). The stale count

 ...
 *
 * Two tables over `GET /api/decisions/history`: the summary (overall, then by setup, then by
 ...
 *
 * "Record now" runs the 17:45 ET job on demand (`POST /api/decisions/record`): it writes

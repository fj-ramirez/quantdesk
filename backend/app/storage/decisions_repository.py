...
`app.storage.bars_repository`: production callers take the cached sessionmaker bound to
...
from app.models.db import Decision, get_engine, get_sessionmaker
from app.scan.decisions import DecisionResult, Opportunity
from app.scan.outcomes import Outcome, TradeSpec

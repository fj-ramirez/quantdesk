...
Sibling of `app/modules/gex/jobs/bars.py`, which owns the settled daily series. The two never write to each
...
from app.modules.gex.models.bars import IntradayBar, LiveQuote
from app.modules.gex.providers.bars import ProviderError
...
logger = logging.getLogger("app.modules.gex.jobs.intraday_bars")

#: Politeness gap between symbols, matching `app/modules/gex/jobs/bars.py`'s own pacing. Six symbols

...
`app.modules.gex.jobs.capture._persist_sync`'s existing duplicate check keys on
...
def chain_fingerprint(snapshot: ChainSnapshot) -> str:
    ...
    Returns:
        64 hex characters, matching `app.modules.gex.models.db.Snapshot.content_hash`'s column width.
    """

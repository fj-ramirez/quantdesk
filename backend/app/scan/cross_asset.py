...
def sector_correlation(
    ...
    # `/api/scan/cross-asset` endpoint reads one shared wide frame holding the sector ETFs
...
def compute_cross_asset_row(
    *,
    ...
    # the `/api/scan/cross-asset` frame is the union calendar of the ETFs and the Cboe index
